...
4. Run ./generate-client-jar
5. Run ./generate-server-jar
6. Run "rmiregistry &" in the same directory repository (or extracted files) is
7. Run server interface provider: ./run-server &
8. Run client interface: ./run-client &
